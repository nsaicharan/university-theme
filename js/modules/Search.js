...
class Search {
  ...
  getResults() {
    $.getJSON(
      ...
      }/wp-json/unirest/v1/search?term=${this.searchField.val()}`,
      results => {
        this.resultsDiv.html(`
				<div class="row">
					<div class="one-third">
              ...
              results.generalInfo.length
                ...
                : `<p>No matching information available.</p>`
            }
							${results.generalInfo
                .map(
                  item => `
              ...
              results.programs.length
                ? '<ul class="link-list min-list">'
                : `<p>No programs match that search. View <a href="${
                    universityData.root_url
                  }/programs">all programs</a>.</p>`
            }
							${results.programs
                .map(
                  item => `
              ...
              results.campuses.length
                ? '<ul class="link-list min-list">'
                : `<p>No campuses match that search. View <a href="${
                    universityData.root_url
                  }/campuses">all campuses</a>.</p>`
            }
							${results.campuses
                .map(
                  item => `
